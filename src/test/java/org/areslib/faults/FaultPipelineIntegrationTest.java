...
public class FaultPipelineIntegrationTest {
    ...
    /**
     * Simulates a hardware disconnect and verifies the fault propagates from
     * FaultMonitor → RobotHealthTracker → AresFaultManager alerts pipeline.
     */
    @Test
    ...
    /**
     * Minimal FaultMonitor implementation for testing the pipeline without
     * needing real hardware or reflection-based drivers.
     */
