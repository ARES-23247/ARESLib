 ...
 * across all registered {@link FaultMonitor} devices and blasts them to both
 * AdvantageScope telemetry AND the {@link org.areslib.faults.AresFaultManager}
 * alert system (which provides gamepad rumble and LED feedback).
 * <p>
 * <b>Must be registered with the CommandScheduler</b> for its periodic() to run.
 * This is handled automatically by {@link org.areslib.core.AresCommandOpMode}.
 */
public class RobotHealthTracker extends SubsystemBase {
    ...
    /**
     * Resets the singleton. Must be called during OpMode transitions to prevent
     * stale monitors from previous OpModes.
     */
    ...
    public void periodic() {
        ...
        for (FaultMonitor monitor : monitors) {
            ...
            AresAlert alert = alertBridge.computeIfAbsent(monitor,
                m -> new AresAlert(m.getFaultMessage(), AresAlert.AlertType.ERROR));
