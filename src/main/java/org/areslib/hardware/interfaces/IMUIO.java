...
/**
 * AdvantageKit-style IO abstraction for IMU units (Inertial Measurement Units).
 * Can be implemented by physical REV Hub IMUs, GoBilda Pinpoints, or simulated kinematics.
 */
