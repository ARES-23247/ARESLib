 ...
 * <p>
 * Copy this file into your teamcode package and rename it.
 * This demonstrates the core ARESLib2 patterns:
 * <ul>
 *   <li>IO abstraction (swap between real hardware and simulation)</li>
 *   <li>Periodic telemetry logging</li>
 *   <li>State machine for intake control</li>
 * </ul>
 *
 * <h3>Quick Start:</h3>
 * <pre>
...
public class SimpleIntakeSubsystem extends SubsystemBase {
    ...
    */
    ...
    public void startIntake() { state = IntakeState.INTAKING; }
    public void eject() { state = IntakeState.EJECTING; }
    public void stop() { state = IntakeState.STOPPED; }
    public boolean hasPiece() { return inputs.pieceDetected; }
}
